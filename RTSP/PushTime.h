//
// Created by 胡启奇 on 2022/11/5.
//

#ifndef RTSP_PUSHTIME_H
#define RTSP_PUSHTIME_H
...
public:
    static PushTime *GetInstance() {
        if (s_publish_time == nullptr)
            s_publish_time = new PushTime();
...
private:
    ...
    static PushTime *s_publish_time;
};
